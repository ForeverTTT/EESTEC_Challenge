...
| 组件 | 版本 / 说明 |
|------|-------------|
| ModusToolbox™ | ≥ 3.6（推荐 3.6.0 或 3.8.0） |
| Arm GNU Toolchain | GCC 14.2.1 |
| DEEPCRAFT™ Studio | 5.12+ |
| Python | 3.8+ |
| 目标板 | PSOC™ Edge E84 AI Kit (`APP_KIT_PSE84_AI`) |

ModusToolbox 安装组件清单（参考）：
- Eclipse IDE for ModusToolbox™
- ModusToolbox™ Tools Package
- ModusToolbox™ Programming Tools
- ModusToolbox™ Machine Learning Pack

详细安装指南：[ModusToolbox Installation Guide](https://www.infineon.com/row/public/documents/30/68/infineon-modustoolbox-software-installation-guide-gettingstarted-en.pdf)
...
- [Infineon Hackathon 原始仓库](https://github.com/Infineon/hackathon)
- [DEEPCRAFT Studio 部署指南 — PSOC Edge](https://developer.imagimob.com/deployment/deploy-models-supported-boards/deploy-siren-detection-model-PSoC-boards)
- [PSOC Edge ML Deploy Audio 示例](https://github.com/Infineon/mtb-example-psoc-edge-ml-deepcraft-deploy-audio)
- [在线烧录工具（数据采集固件恢复）](https://osts.infineon.com/devkit/ai-mcu-applications?id=5)

### 项目文档

- [原始 Challenge README](./README_challenge.md)
- [音源来源与许可证](./sounds/SOURCES.md)
- [Live Data Collection 说明](./LiveDataCollection/README.md)
- [部署工程说明](./test/README.md)

### 可视化材料索引（`assets/`）

所有图片均已嵌入 [方法与思路](#方法与思路) 各节，编号如下：

| Figure | 文件 | 所在章节 |
|--------|------|----------|
| 1 | `data split.png` | §3.2 数据集构成 |
| 2 | `data east.png` | §3.3 East 波形 |
| 3 | `data nord.png` | §3.3 Nord 波形 |
| 4 | `data west.png` | §3.3 West 波形 |
| 5 | `preprocessing.png` | §4 特征工程 |
| 6 | `model architecture.png` | §5 模型架构 |
| 7 | `training paras.png` | §6.1 超参数 |
| 8 | `loss.png` | §6.2 Loss 曲线 |
| 9 | `accuracy.png` | §6.3 Accuracy 曲线 |
| 10 | `confusion metrices_train.png` | §7.2 训练集评估 |
| 11 | `confusion metrices.png` | §7.3 测试集评估 |

---

## Infineon Team（原始 Hackathon）

**Eric** (Embedded Systems Engineer) · **Olaf** (Principal Engineer)

如有问题，可在 [Infineon Hackathon Issues](https://github.com/Infineon/hackathon/issues) 提交。
